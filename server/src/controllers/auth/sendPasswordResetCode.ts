...
export const sendPasswordResetCode = asyncHandler(async (
	...
	await VerificationCode.deleteMany({ email, purpose: VERIFICATION_PURPOSES.RESET_PASSWORD });

	const code = generateSixDigitCode();

	await VerificationCode.create({ email, code, purpose: VERIFICATION_PURPOSES.RESET_PASSWORD });
